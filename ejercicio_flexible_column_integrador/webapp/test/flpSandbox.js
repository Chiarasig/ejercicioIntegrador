		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comproyejercicioflexiblecolumnintegrador-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comproyejercicioflexiblecolumnintegrador-display": {
								"semanticObject": "comproyejercicioflexiblecolumnintegrador",
								"action": "display",
								"description": "A Integrador application.",
								"title": "Integrador Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.proy.ejercicioflexiblecolumnintegrador",
									"url": sap.ui.require.toUrl("com/proy/ejercicioflexiblecolumnintegrador")
								}
							}
						}
					}
